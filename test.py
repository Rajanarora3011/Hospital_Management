while (True):
    ...
    mysql = mysql.connector.connect(host="localhost", user="root", passwd="Rajan@1234", database="city_hospitals")
                    ...
                    while(True):
                        ...
                        if a == 1:
                            print("""
                                    ...
                                    4. Make an exit
                                                             """)
                            b = int(input("Enter your bb Choice:"))
                            # details
                            if b == 1:
                                print("""
                                            1. Doctors Details
                            ...
                            # displays worker details
                                    ...
                                    for i in row:
                                        v = list(i)
                                        k = ["NAME", "AGE", "ADDRESS", "CONTACT", "MONTHLY_SALARY", "Work"]
                                        d = dict(zip(k, v))
                                        print(d)
                            elif b == 2:
                                print("""
                                ...
                                c = int(input("ENTER A MEMBER YOU WANT TO ADD: "))
                            ...
                            # for entering workers details
                                    ...
                                    # INSERTING VALUES ENTERED TO THE TABLE
                                    mycursor.execute(
                                        "insert into other_workers_details values('" + name + "','" + age + "','" + add + "','" + cont + "','" + ms + "','" + work + "')")
                                    mysql.commit()
                                    print("SUCCESSFULLY ADDED")
                            # to delete data
                            elif b == 3:
                                print("You are going to delete a data")
                                print("""
                                            1. Doctor Details
                                            2. Nurse Details
                                            3. Others
                        ...
                        # entering the patient details table
                            ...
                            if b == 1:
                                ...
                                for i in row:
                                    b = 0
                                    v = list(i)
                                    k = ["NAME", "SEX", "AGE", "ADDRESS", "CONTACT", "disease"]
                                    d = dict(zip(k, v))
                                    print(d)
